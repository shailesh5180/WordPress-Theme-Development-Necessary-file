...
To make any script or style or image dynamic
================================ 
...
To call the search form
================================ 
<?php get_search_form(); ?>


Head to the bottom of the script to call all types of scripts
================================ 
<?php wp_head(); ?>


The bottom of the body for calling all kinds of scripts in Footer
================================ 
<?php wp_footer(); ?>


To call all types of scripts in the body
================================ 
<body <?php body_class(); ?>>

For making any data calls from the Customizer
================================ 
<?php echo get_theme_mod('variable name here'); ?> 


Thumbanail Image to show
================================ 
...
To add keyword results to the search form
================================ 
<h1 class="headbar">Your Keyword <span><?php _e(''); echo '&quot;'.$s.'&quot;'; ?></span> Results are bellow </h1>


Keyword Result Styling for search form
================================ 
.headbar {
	background: #fff;
	padding: 10px;
...
specific category To fetch the post from  
==================================== 
<?php 
...
comment reply to do <head>It has to be written in</head> 
================================ 
<?php
...
To bring down the textarea field of the comment form
================================ 
...
comment form Let's remove that con field
================================ 
